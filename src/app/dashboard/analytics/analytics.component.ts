...
import { LiveClicksComponent } from './live-clicks/live-clicks.component';

@Component({
    selector: 'app-analytics',
    standalone: true,
    imports: [AnalyticsOverviewComponent, StatsComponent, RealtimeActiveUsersComponent, BrowserUsedByUsersComponent, DeviceSessionsComponent, ClicksComponent, ImpressionsComponent, SessionsComponent, SessionsByChannelComponent, ClicksByKeywordsComponent, TopBrowsingPagesComponent, UsersByCountryComponent, LiveClicksComponent],
