...
import { LiveClicksComponent } from './dashboard/analytics/live-clicks/live-clicks.component';
import { TicketsPageComponent } from './pages/tickets-page/tickets-page.component';
import { StatisticsPageComponent } from './pages/statistics-page/statistics-page.component';
import { ConversionsPageComponent } from './pages/conversions-page/conversions-page.component';
import { PerformsPageComponent } from './pages/performs-page/performs-page.component';
...
export const routes: Routes = [
    ...
    },
    {
        ...
        children: [
            ...
            {path: 'performs', component: PerformsPageComponent},
            {path: 'short-gen', component: BlankPageComponent},
            {
                path: 'apps',
            ...
            {path: 'live-clicks', component: LiveClicksComponent}
        ]
    },
    {
        path: 'authentication',
